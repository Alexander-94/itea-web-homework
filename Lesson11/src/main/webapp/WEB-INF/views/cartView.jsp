				...
				<tr>
					<td>
					  <a href="./prodFull?productId=${itms.key.id}">
					    <img width="75" src="<c:url value="/resources/images/${itms.key.id}.png" />">
					  </a>
					</td>
					<td width="300">
					...
					<td width="150">
					  <div id="inlnStyle">
					    <img id="inlnStyle" width="25" height="25" src="<c:url value="/resources/images/minus.png" />" onclick="minus(${itms.key.id})" />
						<input type="text" id="qnt${itms.key.id}" value="${itms.value}"	size="2" />
						<img id="inlnStyle" width="25" height="25" src="<c:url value="/resources/images/plus.png" />" onclick="plus(${itms.key.id})" />
     	              </div>
					</td>
					<td>
					  <form action="./cart" method="post">
						 <input type="hidden" name="deleteId" value="${itms.key.id}" />
						 <input type="image" src="<c:url value="/resources/images/del.png" />" width="25" height="40">
					  </form>
					</td>
				</tr>
			</table>
